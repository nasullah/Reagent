...
class SupplierController {
    ...
    def save(Supplier supplierInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.created.message', args: [message(code: 'supplierInstance.label', default: 'Supplier'), supplierInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'supplierInstance.label', default: 'Supplier'), params.id])
                redirect action: "index", method: "GET"
            }
