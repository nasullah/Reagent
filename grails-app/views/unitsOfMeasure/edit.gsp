...
<body>
	...
	<section id="edit-unitsOfMeasure" class="first">
		...
		<g:form method="post" class="form-horizontal" role="form" >
			<g:hiddenField name="id" value="${unitsOfMeasureInstance?.id}" />
			<g:hiddenField name="version" value="${unitsOfMeasureInstance?.version}" />
