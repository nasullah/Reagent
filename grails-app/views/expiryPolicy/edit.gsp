...
<body>
	...
	<section id="edit-expiryPolicy" class="first">
		...
		<g:form method="post" class="form-horizontal" role="form" >
			<g:hiddenField name="id" value="${expiryPolicyInstance?.id}" />
			<g:hiddenField name="version" value="${expiryPolicyInstance?.version}" />
